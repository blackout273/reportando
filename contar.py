def app(environ, start_response):
    ...
    data = b"<html lang='pt-br'>" \
           ...
           b"}" \
           b".container{" \
           b"position:absolute;margin-left:50%;" \
           b"transform:translateX(-50%);margin-top:15%;" \
           b"font-size:2vw;" \
           b"text-align:center;" \
           b"}" \
           b".btn{" \
           ...
           b"</style></head>" \
           b"<body>" \
           b"<div class='container'><h3>Calcule seu Indice de Massa Corporal IMC</h3>" \
           ...
           b"}if(imc>=18.50 && imc<=24.9){" \
           b"document.getElementById('cobaia').innerHTML='<h6>Class: Normal - Obesidade grau 0<h6>'" \
           b"}" \
           b"if(imc>=25.00 && imc<=29.90){" \
           b"document.getElementById('cobaia').innerHTML='<h6>Class: Sobrepeso - Obesidade grau 1<h6>' " \
           b"}" \
           b"if(imc>=30.00 && imc<=39.90){" \
           b"document.getElementById('cobaia').innerHTML='<h6>Class: Obesidade - Obesidade grau 2<h6>'" \
           b"}" \
           b"if(imc>=40.00){" \
           b"document.getElementById('cobaia').innerHTML='<h6>Class: Obesidade Grave - Obesidade grau 3<h6>'" \
           b"}" \
           b"}" \
           b"</script>" \
           b"</html>"
